...
//             
//             #region Blender Tab Properties
//             _exportVisible = serializedObject.FindProperty("bs.exportVisible");
//             _exportObjects = serializedObject.FindProperty("bs.exportObjects");
//             _exportCollections = serializedObject.FindProperty("bs.exportCollections");
//             _collectionFilterMode = serializedObject.FindProperty("bs.collectionFilterMode");
//             _collectionNames = serializedObject.FindProperty("bs.collectionNames");
//             _triangulateMesh = serializedObject.FindProperty("bs.triangulateMesh");
//             _applyModifiers = serializedObject.FindProperty("bs.applyModifiers");
//             _embedTextures = serializedObject.FindProperty("bs.embedTextures");
//             _bakeAnimation = serializedObject.FindProperty("bs.bakeAnimation");
//             _bakeAnimationNlaStrips = serializedObject.FindProperty("bs.bakeAnimationNlaStrips");
//             _bakeAnimationActions = serializedObject.FindProperty("bs.bakeAnimationActions");
//             _simplifyBakeAnimation = serializedObject.FindProperty("bs.simplifyBakeAnimation");
//             #endregion
//             
//             #region Model Tab Properties
//             // Scene
